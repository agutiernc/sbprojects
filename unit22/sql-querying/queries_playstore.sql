...
-- Find the most out of date app. Hint: You don’t need to do it this way, but it’s possible to
--   do with a subquery: http://www.postgresqltutorial.com/postgresql-max-function/
...
SELECT COUNT(reviews) AS reviews_count FROM analytics;
...
--   been installed at least 100,000 times. Display the name of the app along with the number 
